...
#
#   In a One-to-Many relationship, one object of a model can be assoicated with one or more objects of another model.
# For example, a teacher is qualified to teach a subject, but there can be more than one teach in a college who teaches
# the same subject.
#
# The subject model is below:  ##
...
CREATE TABLE "myapp_subject" ("Subjectcode" integer NOT NULL PRIMARY KEY, "name" varchar(30) NOT NULL,
                              "credits" integer NOT NULL, "Qualification" varchar(50) NOT NULL, "email" varchar(50) NOT NULL)


CREATE TABLE "myapp_teacher" ("TeacherID" integer NOT NULL PRIMARY KEY, "Qualification" varchar(50) NOT NULL,
                              "email" varchar(50) NOT NULL,
...
#
#   In a Many-to-Many relationship, multiple objects of one model can be assoicated with multiple objects of another model.
#
# Let's redefine the relationship between the subject and teacher models in the above example. If more than one teacher can
# teach the same subject, a single teacher can teach more than one subject. So, there is a Many-to-Many relationship
# between the two. Django implements this with a Many-to-Many Field type. Let's use it in the subject model.
#
...
CREATE TABLE "myapp_subject_teacher" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
